...
class ReplyAppStateRestorationTest {
    ...
    //Test for configuration change in different window sizes (when you change orientation from portrait to landscape)
    @Test
    @TestCompactWidth
    fun compactDevice_selectedEmailEmailRetained_afterConfigChange() {
        // setup compact window
        // and stateRestorationTester by passing composeTestRule as argument
        ...
        // Open detailed page for third email
        composeTestRule.onNodeWithText(
